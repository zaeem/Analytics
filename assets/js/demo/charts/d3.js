    ...
    var runD3Charts = function () {
       ...
       // D3 charts colors
        ...
        var chart22 = c3.generate({
            ...
            data: {
                columns: [
                    ['Singly', 1150, 1180, 1190, 1000, 1070, 1800, 1150, 1180, 1190, 1000, 1070, 1800],
                    ['Jointly', 910, 1020, 760, 1080, 850, 940, 910, 1020, 760, 1080, 850, 940],
                    ['Either or Survivor', 1000, 1050, 940, 830, 1010, 890, 1000, 1050, 940, 830, 1010, 890]
                ],
                types: {
                    iPhone: 'area',
                    Jointly: 'area',
                    Either or Survivor: 'area'
                }
            }
        });
