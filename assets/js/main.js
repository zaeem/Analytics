...
$("body").prepend("<header class='navbar navbar-fixed-top bg-dark'> <div class='navbar-logo-wrapper'> <a class='navbar-logo-text' href='thumbnail.html'> <b>Paperless Analytics</b> </a> </div><ul class='nav navbar-top-links navbar-right in' id='top_nav'></ul></header>");


array = [' Thumbnail ', ' Comparison ','ocr','Signature Form','Data With Operations','User Graphs']

array_links = ['thumbnail.html','comparison-form.html','ocr.html','signature-form.html','data_with_operations.html','user-info-details.html']

array.forEach(function(val, index){
 $("#top_nav").append("<li><a href="+array_links[index]+" class='active'>"+array[index]+"</a></li>"); 
})
